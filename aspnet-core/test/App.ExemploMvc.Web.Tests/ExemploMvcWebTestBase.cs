...
{
    public abstract class ExemploMvcWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ExemploMvcWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ExemploMvcWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<ExemploMvcDbContext> action)
        {
            using (var context = IocManager.Resolve<ExemploMvcDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<ExemploMvcDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<ExemploMvcDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ExemploMvcDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ExemploMvcDbContext, Task<T>> func)
        {
            T result;
